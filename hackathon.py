            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "When generating SQL queries, always use the following alias conventions:\n"
                        "1.Use 'SR' for the SalesRecords table.\n"
                        "2.Use 'P' for the Products table.\n"
                        "3.Use 'C' for the Customers table.\n"
